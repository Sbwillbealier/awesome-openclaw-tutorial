...
# 2. Agent 配置
openclaw config set agents.tech-dev.models.providers.anthropic.apiKey "sk-ant-agent"
...
# 验证配置
openclaw config get agents.tech-dev.models.providers.anthropic.apiKey
```text
#### 直接编辑配置文件
